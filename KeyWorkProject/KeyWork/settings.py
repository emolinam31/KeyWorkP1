...
SECRET_KEY = 'django-insecure--v)g42=4&6@9&+7p*cg)6^k#cko+tmzf*xrjm2sod7!6r-cak2'
...
STATIC_URL = 'static/'
STATICFILES_DIRS = [BASE_DIR / 'static']  # Directorio para archivos estáticos adicionales
